  ...
  return (
    <Layout>
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-white">
        {/* Hero Section with Enhanced 99Tattoo Branding */}
        <div className="relative bg-gradient-to-r from-red-900 via-red-800 to-black text-white py-20">
          ...
          <div className="relative max-w-7xl mx-auto px-4 text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <div className="flex items-center gap-2 bg-white/10 backdrop-blur-sm px-4 py-2 rounded-full border border-red-300 shadow-lg">
        ...
        <div className="py-16 bg-gradient-to-br from-white to-red-50">
          <div className="max-w-7xl mx-auto px-4">
            ...
            <div className="grid md:grid-cols-2 gap-8 max-w-6xl mx-auto">
              {/* Eventos Comuns */}
              <Card className="p-8 bg-gradient-to-br from-gray-100 to-gray-200 border-gray-300 shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1">
                <div className="text-center">
                  <div className="w-16 h-16 mx-auto mb-6 bg-gray-400 rounded-full flex items-center justify-center shadow-lg">
              ...
              <Card className="p-8 bg-gradient-to-br from-red-50 to-red-100 border-red-200 shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 hover:shadow-red-glow">
                <div className="text-center">
        ...
        {/* Próximos Eventos Section with Enhanced Design */}
            ...
            {loading ? (
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                {publicEvents.map((event) => (
                  <Card 
                    key={event.id} 
                    className="overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-300 bg-gradient-to-br from-white to-red-50 border-2 border-red-100 hover:border-red-300 transform hover:-translate-y-2 group hover:shadow-red-glow"
                  >
                ...
                <div className="relative h-80 overflow-hidden">
                  ...
                  <div className="absolute bottom-6 left-6 text-white">
                    ...
                    <div className="flex flex-wrap gap-3">
                      <Badge className="bg-red-600 text-white px-3 py-1 shadow-lg">
                  ...
                  <div className="grid md:grid-cols-2 gap-8">
                    <div>
                      ...
                      <div className="space-y-4">
                        <div className="flex items-center gap-3 p-3 bg-red-50 rounded-lg border border-red-100 shadow-sm">
                        ...
                        {selectedEvent.participatingArtists && selectedEvent.participatingArtists.length > 0 && (
                          <div className="flex items-start gap-3 p-3 bg-red-50 rounded-lg border border-red-100 shadow-sm">
                    ...
                    <div>
                      ...
                      {selectedEvent.price && selectedEvent.price > 0 && selectedEvent.ticketProduct?.isEnabled ? (
                        <div className="bg-gradient-to-r from-green-50 to-emerald-50 p-6 rounded-lg border border-green-200 mb-6 shadow-lg">
                        ...
                        <div className="bg-gradient-to-r from-blue-50 to-indigo-50 p-6 rounded-lg border border-blue-200 shadow-lg">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                              <div>
                                <Input
                                  ...
                                  required
                                  className="border-blue-200 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 shadow-sm"
                                />
                              </div>
                              <div>
                                <Input
        ...
        <div className="py-16 bg-gradient-to-br from-gray-50 to-white">
          <div className="max-w-7xl mx-auto px-4">
            ...
            <div className="grid md:grid-cols-3 gap-8 mb-12">
              {/* Corporativos */}
              <Card className="p-8 bg-gradient-to-br from-white to-blue-50 border-blue-200 shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 hover:shadow-blue-glow">
                <div className="text-center">
              ...
              {/* Festas e Casamentos */}
              <Card className="p-8 bg-gradient-to-br from-white to-pink-50 border-pink-200 shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
                <div className="text-center">
              ...
              <Card className="p-8 bg-gradient-to-br from-white to-purple-50 border-purple-200 shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
                <div className="text-center">
            ...
            <div className="text-center mb-8">
              ...
              <div className="grid md:grid-cols-4 gap-6 max-w-4xl mx-auto">
                <div className="text-center">
                  <div className="w-12 h-12 mx-auto mb-3 bg-gradient-to-r from-red-600 to-red-800 rounded-full flex items-center justify-center shadow-lg">
                ...
                <form onSubmit={handleCustomEventSubmit} className="space-y-6">
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="relative">
                        ...
                        <Input
                          ...
                          required
                          className="pl-10 bg-white/20 border-red-300 text-white placeholder-red-200 focus:border-red-400 focus:ring-2 focus:ring-red-200 shadow-lg"
                        />
                      </div>
                    </div>
                    <div className="space-y-2">
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="relative">
                        ...
                        <Input
                          ...
                          className="pl-10 bg-white/20 border-red-300 text-white focus:border-red-400 focus:ring-2 focus:ring-red-200 shadow-lg"
                        />
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      <Select value={customEventForm.eventType} onValueChange={(value) => setCustomEventForm({...customEventForm, eventType: value})}>
                        <SelectTrigger className="pl-10 bg-white/20 border-red-300 text-white focus:border-red-400 shadow-lg">
                          <SelectValue placeholder="Selecione o tipo de evento" />
                        </SelectTrigger>
                        <SelectContent className="bg-red-950 border-red-700 text-white shadow-2xl">
                  ...
                  <div className="space-y-2">
                    ...
                    <Textarea
                      ...
                      rows={4}
                      className="bg-white/20 border-red-300 text-white placeholder-red-200 focus:border-red-400 focus:ring-2 focus:ring-red-200 shadow-lg"
                    />
                  </div>
