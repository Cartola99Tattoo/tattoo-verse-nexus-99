...
import { CalendarIcon, Search, Bed, DollarSign, Clock, User, AlertTriangle, CheckCircle, Sparkles, Upload, X, Image, Printer } from "lucide-react";
...
const AppointmentForm = ({ selectedSlot, clients, onSuccess }: AppointmentFormProps) => {
  ...
  const handlePrintForm = () => {
    ...
    // Simular abertura da funcionalidade de impressão
    setTimeout(() => {
      window.print();
    }, 1000);
  };
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
      <div className="bg-white rounded-2xl shadow-2xl border-2 border-red-200/50 relative overflow-hidden max-w-6xl w-full max-h-[95vh] overflow-y-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div className="space-y-3">
                ...
                <div className="space-y-2">
                  ...
                  <Select onValueChange={(value) => setValue('client_id', value)}>
                    ...
                    <SelectContent className="border-2 border-red-200 shadow-xl rounded-lg max-h-48 bg-white z-[60]">
              ...
              <div className="space-y-3">
                ...
                <Popover>
                  ...
                  <PopoverContent className="w-auto p-0 border-2 border-red-200 shadow-xl rounded-lg bg-white z-[60]">
                    <Calendar
                      mode="single"
            ...
            <div className="space-y-4 bg-gradient-to-r from-red-50/80 via-white/90 to-red-50/80 rounded-xl p-6 border-2 border-red-100/50 shadow-lg">
              ...
              <div className="flex flex-wrap gap-3 pt-4 border-t border-red-200">
                <Button
                  ...
                  variant="outline"
                  className="border-2 border-purple-500 text-purple-600 hover:bg-purple-50 shadow-md hover:shadow-lg transition-all duration-300 rounded-lg px-4 py-2 h-auto font-bold"
                >
